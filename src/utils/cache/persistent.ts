import type { BasicKeys, BasicStore } from '#/store';
...
export class Persistent {
  ...
  static setLocal(key: BasicKeys, value: BasicStore[BasicKeys], immediate = false): void {
  ...
  static setSession(key: BasicKeys, value: BasicStore[BasicKeys], immediate = false): void {
